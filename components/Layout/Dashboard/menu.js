      ...
      subMenu: [
        {
          ...
          url: "/dashboard/blogCategories",
        },
        {
          name: t("Add New Category"),
          url: "/dashboard/blogCategories/create",
          create: true,
        },
        {
          name: t("Subcategory List"),
          url: "/dashboard/blogCategories/subcategories",
        },
        {
          name: t("Add New Subcategory"),
          url: "/dashboard/blogCategories/subcategories/create",
          create: true,
        },
      ],
    },
